...
data.map((obj) => {
    ...
    //create 3 bootstrap columns
    let col1 = document.createElement('div')
    col1.setAttribute('class','col-2')
    col1.innerHTML = obj["company_name"];
    ...
    //increase span of about column
    let col3 = document.createElement('div')
    col3.setAttribute('class','col-8')
    col3.innerHTML = obj["about"];

    //append the 3 columns to row
    row.append(col1);
    row.append(col2);
    row.append(col3);

    //append row to table/grid
    table.append(row);
})